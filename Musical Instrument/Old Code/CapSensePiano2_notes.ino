/* This is the origonal code that I used to make my capacity sensor. 
 Since this iteration I have changed the way I wire the cap sensor. The issue with using less pins was that it gave me strange readings
 I've now made it so it is two pins per cap sensor. 
*/
